...
export const fallingUserSfDesktop = keyframes`
  0% {
    opacity: 1;
  ...
  90% {
    opacity: 1;
    transform: translateY(${h * 1.05}px);
  }
  100% {
    opacity: 0;
    transform: translateY(${h * 1.15}px);
}
`;
export const fallingUserSfMobile = keyframes`
  0% {
    opacity: 1;
    transform: translateY(0);
  }
  90% {
    opacity: 1;
    transform: translateY(${h * 1.215}px);
  }
  100% {
    opacity: 0;
    transform: translateY(${h * 1.35}px);
}
`;
